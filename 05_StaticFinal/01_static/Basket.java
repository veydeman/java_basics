public class Basket {
    ...
    private static int allItemsPrice;
    private static int allItemsCount;
    ...
    public static int getAllItemsPrice() {
    ...
    public static void increasePrice(int price, int count) {
        allItemsPrice = allItemsPrice + price * count;
    }

    public static void increaseItemsCount(int count) {
        allItemsCount = allItemsCount + count;
    }

    public static double averageItemPrice() {
        return allItemsPrice / allItemsCount;
    }

    public static double averageBasketPrice() {
        return allItemsPrice / Basket.count;
    }
    ...
    public void print(String title) {
        ...
        if (items.isEmpty()) {
            ...
            System.out.println("Общая масса корзины: " + getTotalWeight());
        }
    }
}
